...
export default function FeaturedFilmCard() {
  return (
    <div className="group  border border-white flex flex-col md:flex-row rounded-lg bg-imperial-gray shadow-lg hover:shadow-white text-white transition-shadow duration-1000">
      ...
      <div className=" flex flex-col justify-between py-4 pr-4">
        <div className="p-6 flex flex-col justify-center gap-4 flex-1">
          <AnimatedTitle title={"The Saga of the Stars"} />
